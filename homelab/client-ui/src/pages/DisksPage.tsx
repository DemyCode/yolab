      ...
      <Card>
        <CardContent className="pt-5">
          <div className="flex items-start gap-3">
            ...
            >
              <GripVertical className="h-4 w-4 text-[#52525b]" strokeWidth={2} />
            </button>
...
export function DisksPage() {
  ...
  async function handleDragEnd(event: DragEndEvent) {
    ...
    const oldIndex = disks.findIndex(d => `${d.host}:${d.name}` === active.id)
    ...
    <div className="space-y-6 max-w-3xl">
      ...
      {disks.length > 0 && (
        <div>
          ...
          >
            <SortableContext items={diskIds} strategy={verticalListSortingStrategy}>
